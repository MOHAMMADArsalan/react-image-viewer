...
function Minus({
  ...
  return (
    <SVGWrap size={size} viewBox="0 0 401.991 401.991">
     <g>
	<path fill={fill} d="M394,154.174c-5.331-5.33-11.806-7.995-19.417-7.995H27.406c-7.611,0-14.084,2.665-19.414,7.995
